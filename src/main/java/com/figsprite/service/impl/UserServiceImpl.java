...
import com.figsprite.common.TokenCache;
import com.figsprite.dao.UserMapper;
import com.figsprite.pojo.User;
import com.figsprite.service.IUserService;
import com.figsprite.util.MD5Util;
...
/*      int resultCount = userMapper.checkUsername(user.getUsername());
    ...
    public ServerResponse<User> updateInformation(User user){
        //username不能更新
        //email不可以重复，不能为其他人的email
        int resultCount = userMapper.checkEmailByUserId(user.getEmail(),user.getId());
        if(resultCount>0){
            return ServerResponse.createByErrorMessage("信息错误，email已存在");
        }
