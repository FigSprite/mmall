...
import com.figsprite.dao.*;
import com.figsprite.pojo.*;
import com.figsprite.service.IOrderService;
import com.figsprite.util.BigDecimalUtil;
import com.figsprite.util.DateTimeUtil;
import com.figsprite.util.FTPUtil;
import com.figsprite.util.PropertiesUtil;
import com.figsprite.vo.OrderItemVo;
import com.figsprite.vo.OrderProductVo;
import com.figsprite.vo.OrderVo;
import com.figsprite.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("FigSprite扫码支付订单号").append(outTradeNo).toString();
        ...
        for (OrderItem orderItem : orderItemList) {
            ...
            GoodsDetail goodsDetail = GoodsDetail.newInstance(orderItem.getId().toString(), orderItem.getProductName(),
                    BigDecimalUtil.mul(orderItem.getCurrentUnitPrice().doubleValue(), Double.valueOf("100")).longValue(),
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (order.getStatus() >= Const.OrderStatusEnum.PAID.getCode()) {
            return ServerResponse.createByErrorMessage("重复调用");
        }
    ...
    public ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            orderItem.setTotalPrice(BigDecimalUtil.mul(orderItem.getCurrentUnitPrice().doubleValue(), cartItem.getQuantity()));
